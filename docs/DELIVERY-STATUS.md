...
| 3. Structures | Published v7 product `044f1fc7ac178149dc0a0a022e48dfd26ca579e5db845b56c271c4ac436ec8f5` has 5,247 qualified bodies and 627 explicit rejections. v8 adds 104 raw-qualified bodies; v9 adds 24 more, reaching 5,375 locally with all 5,351 v8 payloads unchanged. | v7 reader deployment acceptance; combined v8/v9 release; 499 remaining v9 structural rejections including images, formulas, tables and other source forms. Implementable structures remain defects/work, not completed limitations. |
...
Image acquisition remains incomplete: the retained source archives contain no image binaries. Public range probes returned 300 valid image prefixes, followed by 643 HTTP 403 responses consistent with a request cap. Further requests stopped; these failures do not establish missing assets. Formulas are retained as TeX text and require a pinned offline renderer. See `docs/evidence/remaining-source-structures/README.md`.
